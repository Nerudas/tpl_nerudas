...
?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>"  class="uk-height-1-1">
<head>
	...
	<div class="uk-vertical-align-middle uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-4">
		...
		<div id="modal" class="uk-modal">
			<div class="uk-modal-dialog">
				...
				<form action="<?php echo JRoute::_('index.php', true); ?>" method="post" id="form-login" class="uk-form">
					<div id="form-login-username" class="uk-form-row">
						<input type="text" name="username" id="username" class="uk-width-1-1 uk-form-large" autocomplete="off" autocapitalize="none" placeholder="<?php echo JText::_('NERUDAS_EMAIL'); ?>" />
					</div>
					<div id="form-login-password" class="uk-form-row uk-form-password uk-width-1-1">
						<input type="password" name="password" id="passwd" class="uk-width-1-1 uk-form-large" placeholder="<?php echo JText::_('NERUDAS_PASSWORD'); ?>" />
						<a href="" class="uk-form-password-toggle" data-uk-form-password>
							Show
						</a>
					</div>
					<div id="submit-buton" class="uk-form-row">
						<button type="submit" name="Submit" class="uk-width-1-1 uk-button uk-button-primary uk-button-large"><?php echo JText::_('NERUDAS_LOGIN'); ?></button>
					</div>
