...
<div id="add" class="itemlist uk-margin-large-bottom" data-uk-scrollspy="{cls:'uk-animation-fade uk-invisible', target:' .item', delay:50}">
	<div class="uk-grid uk-grid-small" data-uk-grid-margin data-uk-grid-match>
		...
		<div id="item-<?php echo $item->id; ?>" class="item uk-invisible uk-text-center uk-width-xsmall-1-3 uk-width-small-1-4 uk-width-medium-1-5 uk-width-large-1-5 uk-width-xlarge-1-5">
			<a href="<?php echo $item->flink; ?>" class="uk-display-block uk-link-muted">
				<img src="<?php echo $item->menu_image; ?>" alt="<?php echo $item->title; ?>" data-uk-tooltip="{pos:'bottom'}" title="<?php echo $item->title; ?>" />
				<br />
				<?php echo $item->title; ?>
			</a>
		</div>
