	...
	<div class="uk-grid uk-grid-small">
		...
		<div class="uk-width-1-1 uk-width-small-1-3 uk-width-medium-1-3 uk-text-center">
			...
			<div>
					...
					<video class=""  controls="controls" preload="meta" poster="<?php echo $this->answer->image; ?>"  autoplay src="<?php echo $this->answer->video; ?>" style="height:50vh;">
			...
			<div>
				<button class="uk-button uk-button-link" data-uk-tooltip title="<?php echo $doc->getTitle(); ?>">
					<img src="<?php echo $this->answer->image; ?>" alt="<?php echo $this->answer->title; ?>" class="uk-width-4-5" >
				</button>
				<?php /*controls  */ if (!empty($this->answer->audio)): ?>
				<div>
