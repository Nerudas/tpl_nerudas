...
<div class="uk-grid">
	<div class="uk-width-1-2 uk-width-medium-1-3">
		...
		<div>
			<img src="<?php echo $this->character->image; ?>" alt="<?php echo $this->character->name; ?>" class="uk-width-1-1">
		</div>
		<?php endif; ?>
		<?php else: ?>
	...
	<div class="uk-width-1-2 uk-width-medium-2-3">
		...
		<form method="get" class="uk-crearfix uk-margin-top">
			...
			<div class="ya-share2 uk-float-left" data-services="vkontakte,facebook,odnoklassniki,twitter" data-counter="" data-size="m">
			</div>
