...
$image = ($placemark->get('image', false)) ? $placemark->get('image') : 'templates/nerudas/images/placemarks/nerud-car.png';
...
?>
<style>
	[data-prototype-placemark].nerud-car {
		display: block;
		position: relative;
		width: 120px;
		height: 80px;
	...
	[data-prototype-placemark].nerud-car .title {
		position: absolute;
		bottom: 0;
		left: 0;
		width: 120px;
	...
	[data-prototype-placemark].nerud-car .title::after {
		position: absolute;
		right: 0;
		bottom: 0;
		content: '';
	...
	[data-prototype-placemark].nerud-car img {
		position: absolute;
		bottom: 20px;
		left: 0;
		max-width: 75px;
	...
	[data-prototype-placemark].nerud-car .price {
		position: absolute;
		top: 0;
		right: 0;
		width: 63px;
	...
	[data-prototype-placemark].nerud-car .price .type {
		font-size: 12px;
	}

	[data-prototype-placemark].nerud-car .price .number {
		font-size: 20px;
		font-weight: bold;
		text-align: left;
	}

	[data-prototype-placemark].nerud-car[data-viewed="true"] {
		color: inherit;
		width: 90px;
		height: 60px;
		margin-top: -60px;
	...
	[data-prototype-placemark].nerud-car[data-viewed="true"] .title {
		width: 90px;
		height: 15px;
		font-size: 11px;
	}

	[data-prototype-placemark].nerud-car[data-viewed="true"] .title::after {
		content: '';
		width: 7px;
		height: 15px;
	}
	...
	[data-prototype-placemark].nerud-car[data-viewed="true"] .price .type {
		font-size: 9px;
	}

	[data-prototype-placemark].nerud-car[data-viewed="true"] .price .number {
		font-size: 15px;
	}

	[data-prototype-placemark].nerud-car.onModeration .price {
