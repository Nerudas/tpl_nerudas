...
<div id="users" class="reset itemform">
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate uk-form uk-form-horizontal uk-panel uk-panel-box">
		...
		<div class="uk-form-row">
			...
			<div class="uk-form-controls">
				<input aria-invalid="true" name="jform[email]" id="jform_email" value="" class="validate-username required invalid"  required="required" aria-required="true" type="text">
			</div>
		</div>
		<div class="uk-form-row">
			<div class="uk-form-controls">
