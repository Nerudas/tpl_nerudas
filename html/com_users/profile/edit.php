...
$doc->addScript ('/templates/'.$app->getTemplate().'/scripts/tabs_hash.js');
...
<div id="users" class="edit itemform">
	<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate uk-form uk-form-horizontal" enctype="multipart/form-data" >
	<div class="uk-form uk-form-horizontal uk-panel uk-panel-box uk-margin-bottom">
			...
			<div class="uk-form-row uk-text-center uk-margin-large-bottom">
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" class="uk-button uk-button-danger uk-button-large">
