...
<div id="flogin" class="uk-panel uk-panel-box">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_slogin&task=join_mail'); ?>" method="post"  class="uk-form uk-form-horizontal uk-text-center uk-container uk-container-center">
		<div class="uk-form-row">
			<input type="text" name="username" id="username" value="" class="validate-username uk-width-1-1 required" size="25" placeholder="<?php echo JText::_('NERUDAS_EMAIL') ?>" >
		</div>
		<div class="uk-form-row">
			<input type="password" name="password" id="password" value="" class="validate-password required uk-width-1-1" placeholder="<?php echo JText::_('NERUDAS_PASSWORD') ?>" size="25">
		</div>
		<div class="uk-form-row">
			<div class="uk-clearfix">
				<a class="uk-float-right" rel="nofollow" href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>">
					<?php echo JText::_('NERUDAS_FORGOT_PASSWORD'); ?>
				</a>
			</div>
		</div>
		<div class="uk-form-row">
			<button type="submit" class="uk-button uk-button-meddium uk-button-success"><?php echo JText::_('NERUDAS_LOGIN') ?></button>
		</div>
