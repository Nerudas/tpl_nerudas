						...
						<div class="uk-float-left">
							<div class="author">
								<div class="avatar uk-float-left  uk-margin-small-right">
									<a class="uk-text-middle uk-avatar-48 <?php echo $item->author->status; ?>"
									   href="<?php echo $item->author->link; ?>"
									   style="background-image: url('<?php echo $item->author->avatar->small; ?>');">
									</a>
								</div>
								<div class="desc uk-display-inline-block uk-vertical-align" style=" height:48px;">
									<div class="uk-vertical-align-middle">
										...
										<?php if (isset($item->author->job) && !empty($item->author->job->name)): ?>
											<div class="job">
												<a href="<?php echo $item->author->job->link; ?>" target="_blank"
												   class="uk-link-muted">
