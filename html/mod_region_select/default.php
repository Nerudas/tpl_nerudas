					...
					<div id="regionsTabs" class="uk-switcher">
						...
						<div class="all" data-uk-grid>
							...
							<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-1-4 uk-width-large-1-3 uk-width-xlarge-1-3">
								<div class="uk-margin-right uk-margin-bottom uk-margin-left">
									<div class="uk-text-medium">
										<a class="uk-link-muted" data-set-region="<?php echo $group->id; ?>"  title="<?php echo JText::sprintf('NERUDAS_REGION_SELECT_CHANGE_TO', $group->title); ?>" data-uk-tooltip>
									...
									<div class="uk-grid uk-grid-collapse uk-margin-small-top">
										...
										<div class="uk-width-1-2 uk-width-small-1-4 uk-width-medium-1-5">
											<a class="uk-display-block uk-margin-small-bottom uk-margin-small-right" data-set-region="<?php echo $region->id; ?>" title="<?php echo JText::sprintf('NERUDAS_REGION_SELECT_CHANGE_TO', $region->title); ?>" data-uk-tooltip>
												<img src="/templates/nerudas/images/regions/<?php echo $region->id; ?>.png" alt="<?php echo $region->title; ?>" class="uk-width-1-1">
											</a>
										</div>
										<?php endforeach; ?>
							...
							<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-1-4 uk-width-large-1-3 uk-width-xlarge-1-3">
								<div class="uk-margin-right uk-margin-bottom uk-margin-left">
									<div class="uk-text-medium">
										<a class="uk-link-muted" data-set-region="<?php echo $all['100']->id; ?>"  title="<?php echo JText::sprintf('NERUDAS_REGION_SELECT_CHANGE_TO', $all['100']->title); ?>" data-uk-tooltip>
									...
									<div class="uk-grid uk-grid-collapse uk-margin-small-top">
										...
										<?php endforeach; ?>
										<div class="uk-width-1-2 uk-width-small-1-4 uk-width-medium-1-5">
											<a class="uk-display-block uk-margin-small-bottom uk-margin-small-right" data-set-region="<?php echo $all['100']->id; ?>" title="<?php echo JText::sprintf('NERUDAS_REGION_SELECT_CHANGE_TO', $all['100']->title); ?>" data-uk-tooltip>
												<img src="/templates/nerudas/images/regions/<?php echo $all['100']->id; ?>.png" alt="<?php echo $all['100']->title; ?>" class="uk-width-1-1">
											</a>
										</div>
									</div>
								</div>
						...
						<div class="group-<?php echo $group->id; ?>">
							...
							<div class="uk-margin-top">
								...
								<div class="uk-clearfix">
									<a class="uk-display-inline-block uk-margin-bottom uk-margin-small-right" data-set-region="<?php echo $region->id; ?>" title="<?php echo JText::sprintf('NERUDAS_REGION_SELECT_CHANGE_TO', $region->title); ?>" data-uk-tooltip>
										<img src="/templates/nerudas/images/regions/<?php echo $region->id; ?>.png" alt="<?php echo $region->title; ?>" class="uk-align-medium-left uk-margin-small-right uk-margin-bottom-remove">
