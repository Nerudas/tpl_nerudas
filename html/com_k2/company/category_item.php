		...
		<div class="contnent uk-toggle uk-margin-small-top">
			<div class="uk-grid" data-uk-grid-math>
				<div class="uk-width-medium-4-12">
					<a class="image uk-thumbnail uk-display-block uk-cover-background" style="background-image: url('<?php echo $this->item->image; ?>')" data-ratio-height="[166,125]" href="<?php echo $this->item->link; ?>" title="<?php echo $this->item->mintext; ?>" data-uk-tooltip="pos:'bottom-left'">
					</a>
				</div>
				<div class="uk-width-medium-8-12">
					<div class="uk-position-relative uk-height-1-1">
						<h2 class="uk-margin-top-remove uk-text-ellipsis uk-text-large">
							<a href="<?php echo $this->item->link; ?>" class="uk-link-muted uk-text-ellipsis "  title="<?php echo $this->item->mintext; ?>" data-uk-tooltip="pos:'bottom-left', cls:'big'">
		...
		<div class="uk-grid uk-grid-small" data-uk-grid-match>
			...
			<div class="uk-width-1-3 uk-flex uk-flex-right uk-flex-middle  uk-text-right">
				...
				<?php if (!empty($this->item->extra['site']->value)):?>
					<a href="<?php echo $this->item->extra['site']->url;?>" target="_blank"><?php echo $this->item->extra['site']->tvalue; ?></a>
					<?php endif; ?>
				</div>
			</div>
		</div>
