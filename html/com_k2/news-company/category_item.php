...
<div id="item-<?php echo $this->item->id; ?>" class="item uk-invisible" itemscope itemtype="http://schema.org/Article">
	...
	<div class="uk-grid uk-grid-small">
		<div class="uk-width-xsmall-1-2 uk-width-small-1-3 uk-width-medium-1-4 uk-width-large-1-4 uk-width-xlarge-1-4">
			<a class="image uk-thumbnail uk-display-block uk-cover-background"  href="<?php echo $this->item->link; ?>" style="background-image: url('<?php echo $this->item->image; ?>');" data-uk-tooltip="pos:'bottom-left', cls:'big'" title="<?php echo $this->item->title;?>">
			</a>
		</div>
