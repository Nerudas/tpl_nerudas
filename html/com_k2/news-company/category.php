...
<div id="news-company" class="itemlist" data-uk-scrollspy="{cls:'uk-animation-fade uk-invisible', target:' .item', delay:150}">
		...
		<div class="uk-grid" data-uk-grid-match>
			<div class="uk-vertical-align uk-text-center uk-width-xsmall-1-5 uk-width-small-1-10 uk-width-medium-1-10 uk-width-large-1-1 uk-width-xlarge-1-1">
				<div class="uk-vertical-align-middle uk-width-1-1">
					<a href="#rubricsMobile" class="uk-icon-sliders uk-icon-large uk-link-muted" data-uk-offcanvas title="<?php echo JText::_('NERUDAS_FILTER');?>"></a>
				</div>
			</div>
			<div id="appendAddButton" class="uk-text-right uk-width-xsmall-4-5 uk-width-small-9-10 uk-width-medium-9-10 uk-width-large-1-1 uk-width-xlarge-1-1">
			</div>
		</div>
	</div>
