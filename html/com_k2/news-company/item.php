...
<div id="news-company" class="article" itemscope itemtype="http://schema.org/Article">
	...
	<div class="uk-grid uk-grid-small">
		<div class="uk-width-xsmall-1-1 uk-width-small-1-3 uk-width-medium-1-4 uk-width-large-1-4 uk-width-xlarge-1-4">
			<a href="<?php echo $this->item->image; ?>" data-uk-lightbox="{group:'company-news-<?php echo $this->item->id; ?>'}" class="uk-align-medium-left uk-margin-small-top">
		...
		<div class="uk-text-muted uk-width-xsmall-1-1 uk-width-small-1-2 uk-width-medium-1-2 uk-width-large-1-2 uk-width-xlarge-1-2 uk-vertical-align uk-text-right">
			<div class="uk-claerfix uk-vertical-align-middle uk-text-right">
				...
				<div class="uk-float-right uk-margin-small-left">
					...
					>
						<img src="<?php echo $this->item->mapicon; ?>" alt="<?php echo JText::_('NERUDAS_SHOW_ON_MAP'); ?>" />
					</a>
				</div>
				<?php endif;?>
				<div class="ya-share2 uk-float-right" data-services="vkontakte,facebook,odnoklassniki,moimir,gplus,twitter" data-counter="">
				</div>
			</div>
		</div>	
	</div>
	...
	<div class="hidden-microdata">
		<img class="uk-thumbnail uk-width-1-1" src="<?php echo $this->item->image; ?>" alt="<?php echo $this->item->title; ?>" itemprop="image" />
