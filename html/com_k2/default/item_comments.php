	...
	<div id="comment-<?php echo $comment->id; ?>" class="item">
		<div class="uk-grid uk-grid-small">
			...
			<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-1-10 uk-hidden-small">
				<a class="uk-text-middle uk-avatar-48 <?php echo $comment->author->status; ?>" href="<?php echo $comment->author->link; ?>" style="background-image: url('<?php echo $comment->author->avatar->small; ?>')">
				</a>
			</div>
			<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-9-10">
				<div class="header">
					...
					<a class="job uk-text-muted" href="<?php echo $comment->author->job->link; ?>" target="_blank">
