...
<div class="form uk-grid uk-grid-small">
	<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-1-10 uk-hidden-small">
		<a class="image uk-avatar-48 <?php echo $commentsAutho->status; ?>" style=" background-image:url('<?php echo $commentsAuthor->avatar->small; ?>')" href="<?php echo $commentsAuthor->link; ?>" target="_blank">
		</a>
	</div>
	<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-9-10">
		<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate uk-form uk-form-stacked">
			<div class="uk-form-row">
				<div class="uk-form-controls">
					<textarea id="commentText" class="uk-width-1-1" name="commentText" rows="5" placeholder="<?php echo JText::_('NERUDAS_COMEMNTS_TEXT'); ?>"></textarea>
				</div>
			</div>
			...
			<div class="uk-form-row">
				<div class="uk-form-controls uk-text-right">
					...
					<button id="submitCommentButton" class="uk-button uk-button-success" type="submit"><?php echo JText::_('NERUDAS_COMEMNTS_ADD'); ?></button>
				</div>
			</div>
