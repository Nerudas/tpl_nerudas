...
<div class="item herak uk-margin-bottom uk-text-center">
	<a class="uk-overlay uk-overlay-hover uk-display-inline-block uk-width-medium-1-2" href="<?php echo  $this->item->link; ?>">
		<div class="uk-text-center">
			<img src="<?php echo  $this->item->image; ?>" alt="<?php echo str_replace('"','',  $this->item->title); ?>" class="uk-width-1-1" />
		</div>
