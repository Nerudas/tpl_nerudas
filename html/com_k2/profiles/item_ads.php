		...
		<div class="uk-overflow-container">
					...
					<tr>
						<td class="uk-text-middle">
							<div class="title uk-text-slarge">
								<a href="<?php echo $item->url; ?>" class="uk-link-muted"
								   data-uk-tooltip="pos:'bottom-left', cls:'big'" title="<?php echo $item->mintext; ?>">
									<?php echo $item->title; ?>
								</a>
							...
							<?php if ($item->latitude != 0 && $item->longitude != 0):
								...
								<a class="show-modal-map"
								   ...
								   title="<?php echo JText::_('NERUDAS_SHOW_ON_MAP'); ?>">
									<img src="<?php echo $map_icon; ?>"
										 alt="<?php echo JText::_('NERUDAS_SHOW_ON_MAP'); ?>"/>
								</a>
							<?php else: ?>
								<img src="<?php echo $mapa_icon; ?>"
									 alt="<?php echo JText::_('NERUDAS_SHOW_ON_MAP_NO'); ?>"/>
							<?php endif; ?>
						</td>
						<?php if (isset($this->item->editLink)): ?>
							<td style="vertical-align: middle;" class="uk-text-right">
								<a class="uk-icon-pencil uk-icon-small uk-text-muted"
								   href="/forms/ads?cid=<?php echo $item->id; ?>" data-uk-tooltip=""
								   title="<?php echo JText::_('NERUDAS_EDIT'); ?>">
								</a>
							</td>
						<?php endif; ?>
					</tr>
			...
			<?php if ($ads_count > 10): ?>
				<div class="uk-text-right">
					<a href="/ads?filter=true&profile=<?php echo $this->author->id; ?>"
					   class="uk-text-mlarge uk-link-muted uk-text-uppercase">
