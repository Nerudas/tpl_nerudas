			...
			<div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-3-4">
				...
				<div id="myStatus" class="uk-position-relative">
					<div class="status">
						...
						<?php if ($this->author->myStatus){ echo '«'.$this->author->myStatus->text.'»'; } ?>
						</span>
					...
					<form id="myStatusForm" class="uk-form uk-panel uk-panel-box uk-position-top uk-hidden">
						<div class="uk-margin-small-bottom">
							<input id="myStatusForm-text" type="text" name="text" class="uk-width-1-1" <?php if ($this->author->myStatus){ echo 'value="'.$this->author->myStatus->text.'"'; } ?> />
						</div>
